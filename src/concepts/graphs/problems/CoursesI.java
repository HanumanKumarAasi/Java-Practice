...
public class CoursesI {
	...
	//we need to return true, if there is a no cycle exists else false
	...
	public static boolean canFinish(int num, int[][] prerequisites) {
	 ...
	 static void dfs(int node, ArrayList<ArrayList<Integer>> adj, int[] vis,int path[], Stack<Integer> stack){
	        vis[node] = 1;
	        path[node] = 1;
